...
function buildOutlinePrompt(params: {
  ...
  return [
    ...
    "O texto biblico selecionado pelo usuario e a base central obrigatoria do sermao.",
    "Construa a mensagem a partir dos versiculos escolhidos, e nao apenas da referencia como tema solto.",
    "Nao amplie o foco para outras partes do capitulo se isso nao estiver sustentado pelo trecho selecionado.",
...
function buildActionPrompt(
  ...
  if (action === "introduction") {
    return [
      ...
      "A introducao deve surgir do texto biblico selecionado pelo usuario.",
      "Nao trate a referencia apenas como assunto geral; use os versiculos escolhidos como base real da introducao.",
  ...
  if (action === "main_points") {
    return [
      ...
      "Responda em portugues do Brasil com tom pastoral, humano, natural e devocional.",
      "Cada ponto principal deve nascer dos versiculos selecionados pelo usuario.",
      "Nao use o texto apenas como pretexto para ideias gerais; mostre ligacao real com o trecho escolhido.",
  ...
  if (action === "conclusion") {
    return [
      ...
      "Responda em portugues do Brasil com tom pastoral, humano, natural e devocional.",
      "A conclusao deve encerrar a mensagem a partir do texto biblico selecionado pelo usuario.",
      "Nao transforme a conclusao em um apelo desconectado dos versiculos escolhidos.",
  ...
  if (action === "notes_to_point") {
    return [
      ...
      "Responda em portugues do Brasil com tom pastoral, humano, natural e devocional.",
      "As observacoes do usuario sao apoio secundario; o texto biblico selecionado continua sendo a base principal.",
      "O novo ponto precisa manter ligacao clara com os versiculos escolhidos.",
  ...
  if (action === "point_refine") {
    return [
      ...
      "Responda em portugues do Brasil com tom pastoral, humano, natural e devocional.",
      "Ao refinar o ponto, mantenha ligacao clara com o texto biblico selecionado pelo usuario.",
      "Nao melhore o ponto de forma generica ou desconectada dos versiculos escolhidos.",
